...
## [v1.1.9](https://github.com/rommelporras/eventually-consistent/releases/tag/v1.1.9) - 2026-02-12

Fix broken Load More pagination and increase posts per page.

### Fixed
- Load More button now works — implemented AJAX pagination that fetches and appends posts without page reload (was a non-functional placeholder)

### Changed
- Increase `posts_per_page` from 5 to 25 — avoids premature pagination with few posts

## [v1.1.8](https://github.com/rommelporras/eventually-consistent/releases/tag/v1.1.8) - 2026-02-12

Accessible image alt text and documentation updates.

### Fixed
- Featured post carousel images now use `feature_image_alt` from Ghost API with fallback to post title
...
- Replace stale Dawn upstream README inside theme directory
- Complete partials and icons listing in CLAUDE.md

## [v1.1.7](https://github.com/rommelporras/eventually-consistent/releases/tag/v1.1.7) - 2026-02-12

Add path-based filtering to CI/CD pipeline to prevent redundant deployments.

### Changed
- CI pipeline only triggers when files inside `eventually-consistent/` change — eliminates duplicate pipelines during releases
